...
#   timestamp: 2023-11-23T11:54:08+00:00
...
class RunBase(BaseModel):
    ...
    capacity_datetime_convention: str | None = Field(
        None, title="Capacity Datetime Convention"
    )
    production_datetime_convention: str | None = Field(
        None, title="Production Datetime Convention"
    )
...
class UserCreate(BaseModel):
    ...
    terms_conditions_accepted: bool | None = Field(
        None, title="Terms Conditions Accepted"
    )
...
class NodeInput(BaseModel):
    ...
    asset_properties: PowerUnitBase | DummyUnit | None = Field(
        None, title="Asset Properties"
    )
...
class NodeRetrievalResponse(BaseModel):
    nodes: list[NodeOutput] = Field(..., title="Nodes")
    representative_node_ids: list[str] | None = Field(
        None, title="Representative Node Ids"
    )
    node_type_summary: list[NodeTypeSummaryElement] | None = Field(
        None, title="Node Type Summary"
    )
...
class RunExtrema(BaseModel):
    capacity_node_gross: RunSingleExtrema | None
    capacity_node_new: RunSingleExtrema | None
    capacity_node_retirements: RunSingleExtrema | None
    capacity_node_residual: RunSingleExtrema | None
    capacity_edge_gross: RunSingleExtrema | None
    capacity_edge_new: RunSingleExtrema | None
    capacity_edge_retirements: RunSingleExtrema | None
    capacity_edge_residual: RunSingleExtrema | None
    flow: RunSingleExtrema | None
    production: RunSingleExtrema | None
...
class Model(BaseModel):
    ...
    node_type_summary: list[NodeTypeSummaryElement] = Field(
        ..., title="Node Type Summary"
    )
...
class UserFull(BaseModel):
    ...
    recently_viewed_models: list[Model] | None = Field(
        None, title="Recently Viewed Models"
    )


NodeInput.update_forward_refs()
NodeOutput.update_forward_refs()
